...
This is a specialized Claude Code agent for Competitive landscape.
...
Read the system prompt at `src/ideation_agent_competitor_analyst/prompts/system.md` for the agent's detailed behavior.
