...
Competitive Intelligence Scout & Strategy Analyst for the Ideation Pipeline.
...
**Role:** Discovers competitors and analyzes market gaps and differentiation opportunities

**Tools:** WebSearch

**Output:** Competitor landscape, market gaps, differentiation strategies
...
└───────────┬─────────────┘
            ...
            ▼
┌─────────────────────────┐
│  Competitor Analyst Agent     │◄──── This repo
│  (GitHub Actions)       │
└───────────┬─────────────┘
            │
            ▼
...
```bash
ideation-agent-competitor-analyst run --session-id <session-id>
```
...
curl -X POST \
  ...
  https://api.github.com/repos/Othentic-Ai/ideation-agent-competitor-analyst/dispatches \
