"""CLI entry point for the Competitor Analyst agent."""
...
def run(session_id: str, problem: str | None, output_json: bool):
    ...
    console.print(f"[blue]Running competitor-analyst agent for session: {session_id}[/blue]")
    result = run_agent(session_id, problem)
    memory.update_phase("competitor_analyst", "complete", result)

    if output_json:
        print(json.dumps(result, indent=2))
    else:
        console.print("[green]Competitor Analyst agent completed successfully[/green]")
